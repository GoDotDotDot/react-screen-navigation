  ...
  function Screen() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "go", function (path, params) {
      ...
      var _this$props = _this.props,
          keepState = _this$props.keepState,
          originPath = _this$props.path; // 只允许调用 Screen 组件下的 go 方法才保留参数

      history.push("?".concat(qs.stringify(Object.assign({}, serachObj, keepState && path === originPath ? params : null))));
      return null;
    });
  ...
  _createClass(Screen, [{
    ...
    value: function renderScreen(children, props) {
      var _this$props2 = this.props,
          ScreenComponent = _this$props2.component,
